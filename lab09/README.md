...
**Мета:** Навчитися використовувати функціонал JavaScript для роботи з масивами.
...
**Висновок:** Я навчився використовувати функціонал JavaScript для роботи з масивами.